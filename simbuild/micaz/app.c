...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0x2b01798a6cf8, const void *arg_0x2b01798b1020);
#line 775
__extension__ 
#line 792
__extension__ 
...
#line 251
extern double erfc(double arg_0x2b0179928618) __attribute((__leaf__)) __attribute((__nothrow__)) ;
...
unsigned int (*hashfunction)(void *arg_0x2b0179b788e8), 
int (*key_eq_fn)(void *arg_0x2b0179b760c8, void *arg_0x2b0179b76368));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x2b0179d87610, int arg_0x2b0179d87878);
static double RandomUniform(void );
...
typedef uint16_t TPIoTC$Read$val_t;
typedef uint16_t /*TPIoTAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$width_t;
typedef /*TPIoTAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$width_t /*TPIoTAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$Read$val_t;
...
static void TPIoTC$Read$readDone(error_t result, TPIoTC$Read$val_t val);
# 113 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
static void TPIoTC$RadioControl$startDone(error_t error);
#line 138
static void TPIoTC$RadioControl$stopDone(error_t error);
# 75 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static void TPIoTC$sendBroadcast$runTask(void );
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
static 
#line 74
message_t * 
...
uint8_t len);
# 75 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static void TPIoTC$sendToRoot$runTask(void );
# 62 "/opt/tinyos-2.1.2/tos/interfaces/Init.nc"
static error_t LedsP$Init$init(void );
# 75 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static void /*TPIoTAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$senseResult$runTask(void );
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
...
uint8_t len);
# 104 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
static error_t TPIoTC$RadioControl$start(void );
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static error_t TPIoTC$sendBroadcast$postTask(void );
#line 67
static error_t TPIoTC$sendToRoot$postTask(void );
# 34 "TPIoTC.nc"
enum TPIoTC$__nesc_unnamed4301 {
#line 34
  TPIoTC$sendBroadcast = 3U
};
#line 34
typedef int TPIoTC$__nesc_sillytask_sendBroadcast[TPIoTC$sendBroadcast];
...
enum TPIoTC$__nesc_unnamed4302 {
#line 44
  TPIoTC$sendToRoot = 4U
};
#line 44
typedef int TPIoTC$__nesc_sillytask_sendToRoot[TPIoTC$sendToRoot];
#line 16
message_t TPIoTC$packet[1000];
bool TPIoTC$locked[1000];

uint16_t TPIoTC$root_node[1000];
...
static inline void TPIoTC$RadioControl$startDone(error_t err);




static inline void TPIoTC$RadioControl$stopDone(error_t err);
static inline void TPIoTC$Read$readDone(error_t result, uint16_t data);

static inline void TPIoTC$sendBroadcast$runTask(void );
...
static inline void TPIoTC$sendToRoot$runTask(void );



static inline void TPIoTC$assignRootAndSendInfo(uint16_t sender_nodeid);
#line 61
static inline void TPIoTC$forwardInfo(tp_iot_t *message);
#line 73
...
# 63 "/opt/tinyos-2.1.2/tos/interfaces/Read.nc"
static void /*TPIoTAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$Read$readDone(error_t result, /*TPIoTAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$Read$val_t val);
# 47 "/opt/tinyos-2.1.2/tos/system/ConstantSensorC.nc"
enum /*TPIoTAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$__nesc_unnamed4303 {
#line 47
  ConstantSensorC$0$senseResult = 5U
};
#line 47
typedef int /*TPIoTAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$__nesc_sillytask_senseResult[/*TPIoTAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$senseResult];
#line 47
static inline void /*TPIoTAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$senseResult$runTask(void );
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
...
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
inline static error_t TPIoTC$sendToRoot$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(TPIoTC$sendToRoot);
#line 67
...
# 126 "/opt/tinyos-2.1.2/tos/interfaces/Packet.nc"
inline static void * TPIoTC$Packet$getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
#line 61
{
  tp_iot_t *rsm = (tp_iot_t *)TPIoTC$Packet$getPayload(&TPIoTC$packet[sim_node()], sizeof(tp_iot_t ));

#line 63
  if (rsm == (void *)0) {
      return;
    }
  __nesc_hton_uint16(rsm->sender_nodeid.nxdata, __nesc_ntoh_uint16(rsm->sender_nodeid.nxdata));
  __nesc_hton_uint16(rsm->data.nxdata, __nesc_ntoh_uint16(rsm->data.nxdata));
  __nesc_hton_uint8(rsm->message_type.nxdata, __nesc_ntoh_uint8(rsm->message_type.nxdata));

  TPIoTC$sendToRoot$postTask();
}

# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
inline static error_t TPIoTC$sendBroadcast$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(TPIoTC$sendBroadcast);
#line 67
...
#line 50
  ...
  TPIoTC$root_node[sim_node()] = sender_nodeid;
  __nesc_hton_uint16(rsm->sender_nodeid.nxdata, TOS_NODE_ID);
  __nesc_hton_uint16(rsm->data.nxdata, 2);
  __nesc_hton_uint8(rsm->message_type.nxdata, 1);
...
#line 77
    {
      ...
      if (__nesc_ntoh_uint8(rsm->message_type.nxdata) == 0) {
          if (TPIoTC$root_node[sim_node()] == -1 || __nesc_ntoh_uint16(rsm->sender_nodeid.nxdata) == TPIoTC$root_node[sim_node()]) {
              TPIoTC$assignRootAndSendInfo(__nesc_ntoh_uint16(rsm->sender_nodeid.nxdata));
              TPIoTC$sendBroadcast$postTask();
            }
        }
      else {
#line 87
        if (__nesc_ntoh_uint8(rsm->message_type.nxdata) == 1) {
            TPIoTC$forwardInfo(rsm);
          }
        }
      return bufPtr;
    }
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x2b017a178340, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x2b017a178340) {
#line 78
    case 7:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x2b017a178340, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x2b017a176020, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x2b017a176020, msg, payload, len);
#line 78
...
#line 113
  TPIoTC$RadioControl$startDone(error);
#line 113
}
#line 113
# 96 "/opt/tinyos-2.1.2/tos/lib/tossim/TossimPacketModelC.nc"
...
#line 138
  TPIoTC$RadioControl$stopDone(error);
#line 138
}
#line 138
...
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0x2b017a179220, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0x2b017a179220, msg, error);
#line 110
}
#line 110
...
#line 36
  ...
  __nesc_hton_uint16(rsm->sender_nodeid.nxdata, TOS_NODE_ID);
  __nesc_hton_uint8(rsm->message_type.nxdata, 0);
  TPIoTC$AMSend$send(AM_BROADCAST_ADDR, &TPIoTC$packet[sim_node()], sizeof(tp_iot_t ));
}
...
#line 44
{
  TPIoTC$AMSend$send(TPIoTC$root_node[sim_node()], &TPIoTC$packet[sim_node()], sizeof(tp_iot_t ));
}
...
# 63 "/opt/tinyos-2.1.2/tos/interfaces/Read.nc"
inline static void /*TPIoTAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$Read$readDone(error_t result, /*TPIoTAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$Read$val_t val){
#line 63
  TPIoTC$Read$readDone(result, val);
#line 63
}
#line 63
# 47 "/opt/tinyos-2.1.2/tos/system/ConstantSensorC.nc"
...
#line 47
{
  /*TPIoTAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$Read$readDone(SUCCESS, 48879U);
}
...
# 100 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x2b017a3fe1c8, message_t * msg, error_t error){
#line 100
  switch (arg_0x2b017a3fe1c8) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x2b017a3fe1c8, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x2b0179e88020){
#line 75
  switch (arg_0x2b0179e88020) {
#line 75
...
#line 75
      break;
#line 75
    case TPIoTC$sendBroadcast:
#line 75
      TPIoTC$sendBroadcast$runTask();
#line 75
      break;
#line 75
    case TPIoTC$sendToRoot:
#line 75
      TPIoTC$sendToRoot$runTask();
#line 75
      break;
#line 75
    case /*TPIoTAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$senseResult:
#line 75
      /*TPIoTAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$senseResult$runTask();
#line 75
      break;
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0x2b0179e88020);
#line 75
      break;
#line 75
    }
...
#line 67
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x2b017a3fd340, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0x2b017a3fd340, addr, msg, len);
#line 80
...
# 104 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
inline static error_t TPIoTC$RadioControl$start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
#line 55
{
  ...
  /*TPIoTAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(msg, 7);
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "TPIoTC$root_node"))
  {
    *addr = (uintptr_t)&TPIoTC$root_node[__nesc_mote];
    *size = sizeof(TPIoTC$root_node[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  TPIoTC$locked[__nesc_mote] = FALSE;
  memset((void *)&TPIoTC$root_node[__nesc_mote], 0, sizeof TPIoTC$root_node[__nesc_mote]);
